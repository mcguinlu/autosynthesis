...
# Extracting data from _medRxiv_
...
<br>
<br>
Do not allow scraping of the search page
]
...
New data is added to the master spreadsheet
...
Development dataset was split into training (85%) and test (15%) datasets

Training dataset was then under-sampled:
* All eligible records included
* In-eligible records were included at a rate of 1/20
...
No additional preprocessing (e.g. convert numbers to @)

Different dataset - first exposure of model to new dataset
...
Even the best model didn't do very well
...
.larger[
Attempt to set up automatic searching for other databases
